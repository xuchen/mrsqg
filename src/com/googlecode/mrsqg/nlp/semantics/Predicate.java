package com.googlecode.mrsqg.nlp.semantics;
...
import com.googlecode.mrsqg.util.RegexConverter;
...
public class Predicate implements Comparable<Predicate>, Serializable {
	...
	public Predicate(String sentence, String annotated, Term[] terms) throws ParseException {
		...
		if (!verbM.find()) {
			System.err.println("Problem building predicate: " + "TARGET missing.");
			System.err.println("Sentence: " + sentence);
			System.err.println("Annotation: " + annotated);
			System.err.println("Predicate annotation could not be parsed.");
		}
		verb = ASSERT.untokenize(verbM.group(1).trim(), sentence);
		if (verb == null) {
			System.err.println("Problem building predicate: " + "TARGET not in original sentence.");
			System.err.println("Sentence: " + sentence);
			System.err.println("Annotation: " + annotated);
		...
		while (argM.find()) {
			...
			if (arg == null) {
				System.err.println("Problem building predicate: " + role + " not in original sentence.");
				System.err.println("Sentence: " + sentence);
				System.err.println("Annotation: " + annotated);
			} else {
				rolesL.add(role);
